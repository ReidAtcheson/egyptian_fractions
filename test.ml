...
let q1 = Q.make (Z.of_int 5) (Z.of_int 8)
...
(*Test the conversion from modern fraction to Egyptian fraction*)
let test_from_modern = assert ((Q.compare (to_modern (modern_to_egyptian q1)) q1)==0)
